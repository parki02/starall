...
Note that you can (and should) install the Windows version of postgres even when running starall-core from within WSL.
...
- Open the solution `Builds\VisualStudio\starall-core.sln`
