...
==================
These are intructions for building starall-core from source. For a potentially quicker set up we also have starall-core in a docker container: https://github.com/starall/docker-starall-core-horizon
