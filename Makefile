...
pkgdatadir = $(datadir)/starall-core
pkgincludedir = $(includedir)/starall-core
pkglibdir = $(libdir)/starall-core
pkglibexecdir = $(libexecdir)/starall-core
...
#am__append_1 = -DUSE_POSTGRES=1 $(libpq_CFLAGS)
subdir = .
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(top_srcdir)/common.mk AUTHORS COPYING ChangeLog INSTALL NEWS \
...
ACLOCAL = ${SHELL} /root/starall-core/missing aclocal-1.15
AFL_CLANG = 
AFL_CLANGPP = 
AFL_FUZZ = 
AFL_GCC = 
...
AR = ar
AUTOCONF = ${SHELL} /root/starall-core/missing autoconf
AUTOHEADER = ${SHELL} /root/starall-core/missing autoheader
AUTOMAKE = ${SHELL} /root/starall-core/missing automake-1.15
AWK = mawk
CC = gcc
CCACHE = 
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -Wall -Wno-unused-command-line-argument -Wno-unused-local-typedef -Wno-unknown-warning-option -Werror=unused-result
...
CXXFLAGS = -g -O2  -pthread -Wall -Wno-unused-command-line-argument -Wno-unused-local-typedef -Wno-unknown-warning-option -Werror=unused-result
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /root/starall-core/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = starall-core
PACKAGE_BUGREPORT = 
PACKAGE_NAME = starall-core
PACKAGE_STRING = starall-core 0.1
PACKAGE_TARNAME = starall-core
PACKAGE_URL = http://www.starall.org
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
PKGCONFIG_SUBDIRS =  $(top_builddir)/lib/libsodium $(top_builddir)/lib/xdrpp
...
abs_builddir = /root/starall-core
abs_srcdir = /root/starall-core
abs_top_builddir = /root/starall-core
abs_top_srcdir = /root/starall-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/starall-core/install-sh
...
libpq_CFLAGS = 
libpq_LIBS = 
libsodium_CFLAGS = -isystem $(abs_top_builddir)/lib/libsodium/src/libsodium/include -isystem $(top_srcdir)/lib/libsodium/src/libsodium/include -isystem $(top_srcdir)/lib/libsodium/src/libsodium/include/sodium
...
soci_CFLAGS = -isystem $(top_srcdir)/lib/soci/src/core -isystem $(top_srcdir)/lib/soci/src/backends/sqlite3
soci_LIBS = $(top_builddir)/lib/libsoci.a
sqlite3_CFLAGS = -isystem $(top_srcdir)/lib/sqlite
sqlite3_LIBS = 
srcdir = .
subdirs =  lib/libsodium lib/xdrpp
sysconfdir = ${prefix}/etc
target_alias = 
top_build_prefix = 
top_builddir = .
top_srcdir = .
xdrpp_CFLAGS = -isystem $(abs_top_srcdir)/lib/xdrpp -isystem $(abs_top_builddir)/lib/xdrpp
xdrpp_LIBS = $(abs_top_builddir)/lib/xdrpp/xdrpp/libxdrpp.a
SUBDIRS = lib src
AM_EXTRA_RECURSIVE_TARGETS = check-valgrind
ACLOCAL_AMFLAGS = -I m4
dist_doc_DATA = docs/starall-core_example.cfg			\
	docs/starall-core_standalone.cfg			\
	docs/starall-core_testnet.cfg docs/software/admin.md	\
	docs/software/commands.md

man_MANS = docs/starall-core.1
AM_CPPFLAGS = -DSQLITE_OMIT_LOAD_EXTENSION=1 -isystem "$(top_srcdir)" \
	-I"$(top_srcdir)/src" -I"$(top_builddir)/src" \
	$(libsodium_CFLAGS) $(xdrpp_CFLAGS) $(libmedida_CFLAGS) \
	$(soci_CFLAGS) $(sqlite3_CFLAGS) $(libasio_CFLAGS) -isystem \
	"$(top_srcdir)/lib" -isystem \
	"$(top_srcdir)/lib/autocheck/include" -isystem \
	"$(top_srcdir)/lib/cereal/include" -isystem \
	"$(top_srcdir)/lib/util" -isystem \
	"$(top_srcdir)/lib/soci/src/core" $(am__append_1)
EXTRA_DIST = starall-core.supp test/testnet/multitail.conf	\
...
VALGRIND_SUPPRESSIONS_FILES = starall-core.supp
...
docs/starall-core.1: docs/starall-core.1.md docs/software/commands.md
	mkdir -p docs
	sed -ne '/^#/,$$p' "$(top_srcdir)/docs/software/commands.md" \
	    | sed -e '/^%commands%$$/{s///; r/dev/stdin' -e '}' \
	    $(top_srcdir)/docs/starall-core.1.md > tmp.man.md
