...
void
save(Archive& ar, starall::Upgrades::UpgradeParameters const& p)
{
    ar(make_nvp("time", starall::VirtualClock::to_time_t(p.mUpgradeTime)));
...
template <class Archive>
void
load(Archive& ar, starall::Upgrades::UpgradeParameters& o)
{
    time_t t;
    ar(make_nvp("time", t));
    o.mUpgradeTime = starall::VirtualClock::from_time_t(t);
