...
void
HerderImpl::valueExternalized(uint64 slotIndex, StarallValue const& value)
{
    // record metrics
...
HerderImpl::triggerNextLedger(uint32_t ledgerSeqToTrigger)
{
    ...
    StarallValue newProposedValue(txSetHash, nextCloseTime, emptyUpgradeSteps,
                                  0);
