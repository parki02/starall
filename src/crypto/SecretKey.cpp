...
{
size_t
hash<starall::PublicKey>::operator()(starall::PublicKey const& k) const noexcept
{
    assert(k.type() == starall::PUBLIC_KEY_TYPE_ED25519);

    return std::hash<starall::uint256>()(k.ed25519());
}
}
