             ...
             public NonMovableOrCopyable
{
  ...
  protected:
    ...
    void recvMessage(StarallMessage const& msg);
    void recvMessage(AuthenticatedMessage const& msg);
    void recvMessage(xdr::msg_ptr const& xdrBytes);

    virtual void recvError(StarallMessage const& msg);
    // returns false if we should drop this peer
    void noteHandshakeSuccessInPeerRecord();
    void recvAuth(StarallMessage const& msg);
    void recvDontHave(StarallMessage const& msg);
    void recvGetPeers(StarallMessage const& msg);
    void recvHello(Hello const& elo);
    void recvPeers(StarallMessage const& msg);

    void recvGetTxSet(StarallMessage const& msg);
    void recvTxSet(StarallMessage const& msg);
    void recvTransaction(StarallMessage const& msg);
    void recvGetSCPQuorumSet(StarallMessage const& msg);
    void recvSCPQuorumSet(StarallMessage const& msg);
    void recvSCPMessage(StarallMessage const& msg);
    void recvGetSCPState(StarallMessage const& msg);
  ...
  public:
    ...
    void sendMessage(StarallMessage const& msg);
