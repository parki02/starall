 ...
 * `StarallMessage`, in the file src/xdr/Starall-overlay.x
 *
 ...
 *
 * The `StarallMessage` union contains 3 logically distinct kinds of message:
 *
...
class OverlayManager
{
  public:
    ...
    // Herder.
    virtual void broadcastMessage(StarallMessage const& msg,
                                  bool force = false) = 0;
    ...
    virtual void recvFloodedMsg(StarallMessage const& msg,
                                Peer::pointer peer) = 0;
