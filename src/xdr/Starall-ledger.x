...
/* StarallValue is the value used by SCP to reach consensus on a given ledger
*/
struct StarallValue
{
...
struct LedgerHeader
{
    ...
    StarallValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from StarallValue is normalized such that
