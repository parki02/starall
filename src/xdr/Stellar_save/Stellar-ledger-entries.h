...
#ifndef __XDR_XDR_STELLAR_LEDGER_ENTRIES_H_INCLUDED__
#define __XDR_XDR_STELLAR_LEDGER_ENTRIES_H_INCLUDED__ 1
...
#endif // !__XDR_XDR_STELLAR_LEDGER_ENTRIES_H_INCLUDED__
