# SCP (Starall Consensus Protocol)
...
XDR, in the file [Starall-SCP.x](../xdr/Starall-SCP.x)

The `starall-core` program has a single subclass of SCP called
...
For details of the protocol itself, see the [paper on SCP](https://www.starall.org/papers/starall-consensus-protocol.pdf).
